...
const Sidebar = () => {
  ...
  return (
    <div
      className={`${
        collapsed ? "w-20" : "w-64"
      } hidden md:block flex-shrink-0 transition-all duration-300 ease-in-out h-screen bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700`}
    >
